    ...
    <div id="slider-revolution">
        <ul>
            <li data-transition="fade">
                <img src="Lotus/images/slider/img-1.jpg" data-bgposition="left center" data-duration="14000" data-bgpositionend="right center" alt="">
                <div class="tp-caption sft fadeout slider-caption-sub slider-caption-1" data-x="center" data-y="100" data-speed="700" data-start="1500" data-easing="easeOutBack">
                    <img src="Lotus/images/slider/hom1-slide1.png" alt="icons">
                </div>
            ...
            <li data-transition="fade">
                ...
                <div class="tp-caption sft fadeout" data-x="center" data-y="195" data-speed="700" data-start="1300" data-easing="easeOutBack">
                    <img src="Lotus/images/icon-slider-1.png" alt="">
                </div>
                ...
                <div class="tp-caption sfb fadeout slider-caption-sub slider-caption-sub-3" data-x="center" data-y="395" data-easing="easeOutBack" data-speed="700" data-start="2400"><img src="Lotus/images/icon-slider-2.png" alt=""></div>
            </li>
        </ul>
    </div>
</section>
