    ...
    <div id="slider-revolution">
        <ul>
            <li data-transition="fade">
                ...
                <a href="{{ route('seachroom.detailallroom') }}" class="tp-caption sfb fadeout awe-btn awe-btn-12 awe-btn-slider" data-x="center"
            ...
            <li data-transition="fade">
                ...
                <div class="tp-caption sfb fadeout slider-caption-sub slider-caption-sub-3" data-x="center" data-y="395" data-easing="easeOutBack" data-speed="700" data-start="2400"><img src="{{ asset('Lotus/images/icon-slider-2.png') }}" alt=""></div>
            </li>
